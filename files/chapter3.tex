...
Hence for the further analysis of the module, FFT is chosen as the most compute intensive algorithm of the application because of its dimensions and complexity.
